                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="transport-item__description">
                            <div class="transport-item__description__head"><?=$item['NAME'];?></div>
                            <div class="transport-item__description__title"><?=$item['PROPERTIES']['TITLE_PREVIEW_DESCRIPTION']['VALUE'];?></div>
                            <p class="transport-item__description__text">
                                <?=$item['PREVIEW_TEXT'];?>
                            </p>
                            <a href="<?=$item['DETAIL_PAGE_URL'];;?>" class="item-card__content__more">
