...
$APPLICATION->SetPageProperty("title", "Туры и экскурсии на Кавказских Минеральных Водах и на Кавказе – турфирма «Ладья»");
$APPLICATION->SetPageProperty("keywords", "турфирмы пятигорска, туристические фирмы пятигорска");
$APPLICATION->SetPageProperty("description", "Ведущий туроператор по организации туров в регионе Кавказских Минеральных вод (Пятигорск, Кисловодск, Железноводск, Ессентуки) и на Кавказе. Прием, размещение, транспортное и экскурсионное обслуживание групп и индивидуальных туристов в Пятигорске, Кисловодске, Железноводске, Ессентуках. Лечение в санаториях.");
$APPLICATION->SetTitle("Туры и экскурсии на Кавказских Минеральных Водах (Пятигорск, Кисловодск, Железноводск, Ессентуки) и на Кавказе.");
?>
    <!-- SECTION 2 -->
